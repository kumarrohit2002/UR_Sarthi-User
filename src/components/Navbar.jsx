...
const Navbar = () => {
    const {isLogin,setIsLogin}=useContext(AuthZContext);
        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                    ...
                    <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.o  rg/2000/svg" fill="none" viewBox="0 0 17 14">
                    ...
                    bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="#" className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent
                             md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">
                                Home
                            </a>
                        </li>
                        <li>
                            <a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 
                        ...
                        <li>
                            {
                                isLogin ?
                                    //profile pic
                                    <img className="h-[35px] w-[35px] rounded-full" src={ProfilePic} alt="Pic" />
                                    :
                                    // /* login button */
                                    <button onClick={() => {
                                        setIsLogin(true);
                                    }} className="text-white bg-orange-500 hover:bg-orange-700 px-2 rounded py-1">
                                        LogIn
                                    </button>
                            }
                        </li>
